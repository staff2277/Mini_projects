const Footer = () => {
  return (
    <div className="sm:px-[5%] max-sm:px-[15px] bg-[#0F0F0F]">
      <div className=" py-[5rem] flex justify-between mt-[8rem] bg-[#0F0F0F]">
        <div className="flex flex-col">
          ...
          <a
            href="#"
            className="my-3 max-xl:text-center text-[#999999] sm:text-[1rem] max-5s:text-[0.8rem]"
          >
            Categories
          </a>
          <a
      ...
      <div className="flex justify-between border-t-[0.01rem] border-[#202020]">
        <div className="py-3  text-[#999999] sm:text-[1rem] max-5s:text-[0.8rem]">
          @2025 streamvib, All Rights Reserved
        </div>
        <div className="py-3  text-[#999999] sm:text-[1rem] max-5s:text-[0.8rem]">
