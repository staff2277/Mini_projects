  ...
  return (
    <div className="flex justify-between z-20 items-center max-sm:pt-5 sm:pt-8 absolute w-full border-2 sm:px-[50px]  max-sm:px-[20px]">
      ...
      <nav className={"flex bg-[#0F0F0F] mr-[120px] max-lg:hidden gap-3 border-[4px] border-[#1F1F1F] px-[10px] py-[10px] rounded-xl items-center" }>
        <Link to="/" className={location.pathname === "/" && "py-4 px-5 bg-[#1A1A1A] rounded-lg "}>Home</Link>
        <Link to="/moviesXshows" className={location.pathname === "/moviesXshows" && "py-4 px-5 bg-[#1A1A1A] rounded-lg "}>MoviesXShows</Link>
        <Link to="/support" className={location.pathname === "/support" && "py-4 px-5 bg-[#1A1A1A] rounded-lg "}>Support</Link>
        <Link to="/subscriptions" className={location.pathname === "/subscriptions" && "py-4 px-5 bg-[#1A1A1A] rounded-lg "}>Subscriptions</Link>
      </nav>
